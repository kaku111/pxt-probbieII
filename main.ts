//% weight=0 color=#FF8B27 icon="\uf1b9" block="ProbbieII"
//uf1b9
namespace ProbbieII {    
    let event_src_ir = 12;
...
/**
    ...
    */
    ...
    //}
    /**
    *Probbie-II walks forward.
    */
    //% blockId="forward" block="Probbie-II walking forward"
    ...
    /**
    *Probbie-II walks backward.
    */
    //% blockId="backward" block="Probbie-II walking backward"
    ...
    /**
    *Probbie-II stops walking.
    */
    //% blockId="stopWalk" block="Probbie-II stop walking"
    ...
    /**
    *Probbie-II rotates to the right.
    */
    //% blockId="rightWard" block="Probbie-II turns right"
    ...
    /**
    *Probbie-II rotates to the left.
    */
    //% blockId="leftWard" block="Probbie-II turns left"
    ...
    /**
    *Probbie-II stops rotating.
    */
    //% blockId="stopTurn" block="Probbie-II stops rotating."
 ...
 /**
    *Probbie-II stamps his foot for a certain number of times.
    *@param time describe parameter here, eg:5
    */
    //% blockId="vibrate" block="Probbie-II stamps %time times"
 ...
 /**
    *Probbie-II shakes his head for a certain number of times.
    *@param time describe parameter here, eg:5
    */
    //% blockId="shake_head" block="Probbie-II shakes head %time times"
    //% time.min=1 time.max=100
...
/**
    *Probbie-II repeats the dance for for a certain number of times.
    *@param time describe parameter here, eg:5
    */
    //% blockId="dance" block="Probbie-II dances %time times"
    //% time.min=1 time.max=100
...
/**
    *Probbie II shows his mood on the face (APP only).
    *@param RX_Data describe parameter here
    */
    //% blockId="BLE_DOT" block="Probbie II shows mood on face(APP only) %RX_Data"
